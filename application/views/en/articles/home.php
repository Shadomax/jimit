                        ...
                        <div class="col-xs-12 col-sm-8 post_left">
                            ...
                            <?php if (count($articles) == 0) :?>
                                ...
                                <div class="post">
                                    ...
                                    <div class="meta">
                                        <span class="author">By: <a href="<?=URL::site('articles/article'.'/'.$article->id.'/'.URL::title($article->title, '_'))?>"> <?=strip_tags($article->posted_by)?></a></span>
                                        <span class="category"> <a href="<?=URL::site('articles/article'.'/'.$article->id.'/'.URL::title($article->title, '_'))?>"><?=strip_tags($article->category->name)?></a></span>
                                    ...
                                    <h1><a href="<?=URL::site('articles/article'.'/'.$article->id.'/'.URL::title($article->title, '_'))?>"><?=strip_tags($article->title)?></a></h1>
                                    <div class="post_desc">
                                        <p>
