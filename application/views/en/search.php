                            ...
                            <div class="post_left_section post_left_border">
                                <?php if (count($programs) == 0) :?>
                                    <div class="alert alert-info" role="alert">
                                        <strong>Heads up!</strong> No search result found.
                                    </div>
                                <?php endif;?>
                                <h5>Search Results: <?=$total_program?> Programs Found</h5><br />
                                <?php foreach ($programs as $program) :?>
                                <div class="post">
                                    <div class="meta">
                                        <span class="author">Tuition: <?=$program->tution_fee?></span>
                                        <span class="category"> </span>
                                        <span class="date">Length of Study: <?=$program->certificate->length?></span>
                                    </div><!--end meta-->
                                    <h1><a href="<?=URL::site('programs/program'.'/'.$program->id.'/'.URL::title($program->title, '_'))?>"><?=strip_tags($program->title)?></a></h1>
                                    <div class="post_desc">
                                        <p>
                                ...
                                <div class="related_post_sec">
                                    <div class="list_block">
                                        ...
                                        <ul>
                                            ...
                                            <?php if (count($popular) == 0) :?>
                                              <div class="alert alert-info" role="alert">
                                                <strong>Heads up!</strong> No popular program to display
                                              </div>
                                            <?php endif;?>
                                            </li>
                                          ...
                                          <li class="related_post_sec single_post">
                                            ...
                                            <div class="rel_right">
                                              <h4><a href="<?=URL::site('programs/program'.'/'.$program->id.'/'.URL::title($program->title, '_'))?>"><?=strip_tags($program->title)?></a></h4>
                                              <div class="meta">
                                      ...
                                      <?php endforeach; ?>
                                        ...
                                        <a href="<?=URL::site('programs')?>" class="btn btn-default btn-block commonBtn">More</a>
                                      </div>
                                    </div>
                                    ...
                                    <div class="list_block">
                                        <div class="formTitle news">
                                            ...
                                            <a href="" download="" class="btn btn-default btn-block commonBtn" type="button">Get It Now</a>
                                        </div>
                                    </div>
