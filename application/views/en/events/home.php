                ...
                <div class="col-xs-6 col-sm-6">
                  <div class="related_post_sec single_post">
                    ...
                    <div class="rel_right">
                      ...
                      <a href="<?=URL::site('events/event'.'/'.$event->id.'/'.URL::title($event->title, '_'))?>" class="btn btn-default commonBtn">view Detals</a>
                    </div>
                  </div>
                </div>
              <?php endforeach;?>
              ...
              <div class="related_post_sec">
                ...
                <div class="list_block">
                  <div class="formTitle news">
                    ...
                    <a class="btn btn-default btn-block commonBtn" href="#" download="" type="button">Get It Now</a>
                  </div>
                </div>
                <div class="list_block">
