        ...
        <ul class="topbar-right">
          ...
          <li class="dropdown language">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="<?=URL::site()?>">Anglais</a></li>
            ...
            <div class="col-xs-12">
              <div class="header_inner">
                ...
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand logo clearfix" href="<?=URL::site('fr/home')?>"><img src="<?=URL::base()?>media/img/logo.png" alt="<?=Kohana::$config->load('design')->app_name?>" class="img-responsive" /></a>
                </div>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="main-nav">
                  <ul class="nav navbar-nav navbar-right">
                  <li class="active"><a href="<?=URL::site('fr/home')?>">Accueil</a></li>
                  <li >
                    <a href="<?=URL::site('fr/programs')?>" role="button">Programmes</a>
                  </li>
                  <li>
                    <a href="<?=URL::site('fr/articles')?>" role="button">Blog</a>
                  </li>
                  <li>
                    <a href="<?=URL::site('fr/events')?>" role="button">Événements</a>
                  </li>
                  <li><a href="<?=URL::site('fr/gallery')?>">Galerie</a></li>
                  <li><a href="<?=URL::site('fr/about')?>">À propos</a></li>
                  <li><a href="<?=URL::site('fr/contact')?>">Contactez</a></li>
                  </ul>
                </div><!-- navbar-collapse -->
              </div>
            </div>
