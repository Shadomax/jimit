        ...
        <div class="row clearfix">
          <div class="col-xs-12">
            <div class="aboutTitle">
              <h2>NOS PROGRAMMES POPULAIRES</h2>
            </div><!-- aboutTitle -->
        ...
        <div class="row clearfix">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <div class="rel_right">
                      ...
                      <div class="meta">
                        <span class="author">Publié dans: <a href="<?=URL::site('articles/article').'/'.$article->id.'/'.URL::title($article->title, '_')?>"><?=$article->category->name?></a></span>
                        <span class="date">sur: <a href="<?=URL::site('articles/article').'/'.$article->id.'/'.URL::title($article->title, '_')?>"><?=date('F', $article->datetime)?> <?=date('d', $article->datetime)?>, <?=date('Y', $article->datetime)?></a></span>
                      </div>
                      <p>
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="formArea clearfix">
              ...
              <form action="<?=URL::site('fr/home/search')?>" method="get">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" id="program" name="program" placeholder="Nom du programme">
                </div>
                <button type="submit" class="btn btn-default btn-block commonBtn">Rechercher</button>
              </form>
            </div><!-- formArea -->
            <div class="list_block related_post_sec">
              ...
              <?php endforeach; ?>
                ...
                <a href="<?=URL::site('events')?>" class="btn btn-default btn-block commonBtn">Plus d'événements</a>
              </div>
            </div><!-- end list_block -->
