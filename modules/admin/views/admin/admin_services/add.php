<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Add Service
            <small>Use these section to add new service content.</small>
          </h1>
          <ol class="breadcrumb">
			...
			<!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Service Add Form</h3>
                </div><!-- /.box-header -->
                <?php if (!empty($errors)): ?>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <label for="title" class="text-warning"><?=Arr::get($errors, 'title'); ?></label>
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'title'); ?>" id="title" placeholder="Service Name" name="title">
                      </div>
                    </div><!-- /.form-group -->
                    <div class="form-group">
