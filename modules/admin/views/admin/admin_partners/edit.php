<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Edit Partner
            <small>Use this section to edit partner content.</small>
          </h1>
          <ol class="breadcrumb">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                  ...
                  <?php endif;?>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="name" class="form-control" value="<?=$partner->name?>" id="name" placeholder="Partner Name (e.g MTN)">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <div class="box-body pad">
                          <textarea class="wysiwygtextarea" name="content" placeholder="Place your service content here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=$partner->content?></textarea>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="number" id="sort" name="sort" value="<?=$partner->sort?>">
