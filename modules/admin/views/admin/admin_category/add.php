<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Add Category
            <small>Use this section to add new category.</small>
          </h1>
          <ol class="breadcrumb">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'name'); ?>" id="name" placeholder="Category Name" name="name">
