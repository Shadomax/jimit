<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            ...
            <small>Use this section to add new certificate.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?=url::site('admin/dashboard')?>"><i class="fa fa-dashboard"></i> Admin</a></li>
            <li><a href="<?=url::site('admin/certificates')?>">Certificate</a></li>
			...
			<!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title"> Certificate Add Form</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'name'); ?>" id="name" placeholder="Certificate Name" name="name">
                  ...
                  <div class="form-group">
                  	...
                  	<div class="col-sm-10">
                  		<input class="form-control" type="text" id="content" name="content" value="<?=Arr::get($values, 'content'); ?>" placeholder="Enter category description">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control" type="text" id="length" name="length" value="<?=Arr::get($values, 'length'); ?>" placeholder="Enter the number of years to obtain the certificate">
