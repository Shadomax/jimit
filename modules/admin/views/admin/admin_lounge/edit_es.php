<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Edit Lounge
            <small>Use these section to manage your lounge content.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?=url::site('admin/dashboard')?>"><i class="fa fa-dashboard"></i> Admin</a></li>
            <li><a href="<?=url::site('admin/lounges')?>">Lounge</a></li>
            <li class="active">Edit Lounge</li>
          </ol>
    </section>
			...
			<!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Lounge Edit Form</h3>
                </div><!-- /.box-header -->
                <?php if (!empty($errors)): ?>
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <label for="title" class="text-warning"><?=Arr::get($errors, 'title')?></label>
                        <input type="text" class="form-control" value="<?=@strip_tags($lounge->title)?>" id="title" name="title" placeholder="Lounge Name">
                      </div>
                    </div><!-- /.form-group -->
                   <div class="form-group">
                      ...
                      <label for="feature" class="text-warning"><?=Arr::get($errors, 'feature'); ?></label>
                        <select class="form-control select2" id="feature" name="feature" style="width: 100%;">
                          <option value="no" <?=($lounge->cover == 'no') ? 'selected' : '' ;?>>no</option>
                          <option value="yes" <?=($lounge->cover == 'yes') ? 'selected' : '' ;?>>yes</option>
                        </select>
                      </div>
                    </div><!-- /.form-group -->
                  <div class="form-group">
                    ...
                    <label for="content" class="text-warning"><?=Arr::get($errors, 'content')?></label>
                  		<div class="box">
			                ...
			                <div class="box-body pad">
			                    <textarea class="wysiwygtextarea" name="content" placeholder="Place your portfolio content here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=@strip_tags($lounge->content)?></textarea>
			                </div>
			              </div>
                  	</div>
                  </div><!-- /.form-group -->
                  <!--<div class="form-group">
                    ...
                    <label for="file" class="text-warning"><?=Arr::get($errors, 'file')?></label>
                  		<img src="<?=$lounge->getPicture()?>" style="width:100px; height:100px;" alt="" class="" />
                  ...
                  <div class="form-group">
                  	...
                  	<div class="col-sm-10">
                  		<input class="form-control" type="text" id="seo_title" name="seo_title" value="<?=@strip_tags($lounge->seo_title)?>">
                  	</div>
                  </div><!-- /.form-group -->
                  <div class="form-group">
                  	<label for="seo_description" class="col-sm-2 control-label"><abbr title="Search Engine Optimization">SEO</abbr> Description</label>
                  	<div class="col-sm-10">
                  		<input class="form-control" type="text" id="seo_description" name="seo_description" value="<?=@strip_tags($lounge->seo_description)?>">
                  	</div>
                  </div><!-- /.form-group -->
                  <div class="form-group">
                  	<label for="seo_keywords" class="col-sm-2 control-label"><abbr title="Search Engine Optimization">SEO</abbr> Keywords</label>
                  	<div class="col-sm-10">
                  		<input class="form-control" type="text" id="seo_keywords" name="seo_keywords" value="<?=@strip_tags($lounge->seo_keywords)?>">
                  	</div>
                  </div><!-- /.form-group -->
                  <div class="form-group">
                  	<label for="sort" class="col-sm-2 control-label">Sort Order</label>
                  	<div class="col-sm-10">
                  		<input class="form-control" type="text" id="sort" name="sort" value="<?=@strip_tags($lounge->sort)?>">
                  	</div>
                  </div><!-- /.form-group -->
