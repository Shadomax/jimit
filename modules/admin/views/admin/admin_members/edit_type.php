<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            ...
            <small>Use these section to edit member type.</small>
          </h1>
          <ol class="breadcrumb">
			...
			<!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Type Form</h3>
                </div><!-- /.box-header -->
                <div class="messages" style="">
                 
                </div>
                <!-- form start -->
                <form class="form-horizontal" method="post" data-name="edit-form" action="<?=URL::site('admin/types/edit').'/'.$type->id?>" id="form-type" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="name" class="col-sm-2 control-label">Name <span class="text-danger">*</span></label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?=@strip_tags($type->name)?>" id="name" name="name" placeholder="Enter Name">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?=@strip_tags($type->description)?>" id="description" name="description" placeholder="Enter Description">
