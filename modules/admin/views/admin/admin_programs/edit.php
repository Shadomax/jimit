<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Edit Program
            <small>Use this section to edit program for english.</small>
          </h1>
          <ol class="breadcrumb">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control select2" id="popular" name="popular" style="width: 100%;">
                          <option value="no" <?=($program->popular == 'no') ? 'selected' : ''?>>No</option>
                          <option value="yes" <?=($program->popular == 'yes') ? 'selected' : ''?>>Yes</option>
                        </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <img src="<?=$program->getPicture()?>" class="img-thumbnail" alt="<?=$program->title?>" style="width:100px; height:50px">
