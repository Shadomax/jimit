<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Add Event
            <small>Use this section to add new events.</small>
          </h1>
          <ol class="breadcrumb">
			...
			<!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Event Add Form</h3>
                </div><!-- /.box-header -->
                <?php if (!empty($errors)): ?>
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                  <h4 class="text-center">Fill the form below. All Fields with <span class="text-danger">*</span> Are required.</h4>
                  <div class="box-body">
                    <div class="form-group">
                      <label for="name" class="col-sm-2 control-label">Name <span class="text-danger">*</span></label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'name'); ?>" id="name" placeholder="Event Name" name="name" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'location'); ?>" id="location" placeholder="Event Location" name="location" >
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" value="<?=Arr::get($values, 'date'); ?>" id="date" placeholder="Event Date" name="date">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="time" class="form-control" value="<?=Arr::get($values, 'time'); ?>" id="time" placeholder="Event Time" name="time" >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <div class="box-body pad">
                          <textarea class="wysiwygtextarea" name="content" placeholder="Place your event content here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=Arr::get($values, 'content'); ?></textarea>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" value="<?=Arr::get($values, 'sort'); ?>" id="sort" placeholder="Event Sort" name="sort" >
