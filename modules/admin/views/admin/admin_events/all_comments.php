<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Comments
            <small>Use this section to manage events comments.</small>
          </h1>
          <ol class="breadcrumb">
                    ...
                    <thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-success" type="button" href="<?=URL::site('admin/events/comments').'/'.$comment->id.'/'.URL::title($comment->name,'_')?>">View Comment</a> | <a class="btn btn-danger delete_item" href="<?=URL::site('admin/events/deleteComment').'/'.$comment->id?>" type="button" data-toggle="modal">Delete</a>
                          </td>
                        </tr>
                      <?php endforeach;?>
                    </tbody>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Delete Comment Confrimation</h4>
                  </div>
