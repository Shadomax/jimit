<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Add Team
            <small>Use these section to add new team member.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?=url::site('admin/dashboard')?>"><i class="fa fa-dashboard"></i> Admin</a></li>
            <li><a href="<?=url::site('admin/teams')?>">Teams</a></li>
			...
			<!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Team Add Form</h3>
                </div><!-- /.box-header -->
                <?php if (!empty($errors)): ?>
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <label for="name" class="text-warning"><?=Arr::get($errors, 'name'); ?></label>
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'name'); ?>" id="name" placeholder="Team Member Name" name="name">
                      </div>
                    </div><!-- /.form-group -->
                    <div class="form-group">
                      ...
                      <label for="position" class="text-warning"><?=Arr::get($errors, 'position'); ?></label>
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'position'); ?>" id="position" placeholder="Team Member Position" name="position">
                      </div>
                    </div><!-- /.form-group -->
                  <div class="form-group">
                    ...
                    <label for="bio" class="text-warning"><?=Arr::get($errors, 'bio'); ?></label>
                  		<div class="box">
			                ...
			                <div class="box-body pad">
			                    <textarea class="wysiwygtextarea"id="editor1" name="bio" placeholder="Place your team bio here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=Arr::get($values, 'bio'); ?></textarea>
			                </div>
			              </div>
                  	</div>
                  </div><!-- /.form-group -->
                  <div class="form-group">
                      ...
                      <label for="twitter_link" class="text-warning"><?=Arr::get($errors, 'twitter_link'); ?></label>
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'twitter_link'); ?>" id="twitter_link" placeholder="Team Member Twitter Link" name="twitter_link">
                      </div>
                    </div><!-- /.form-group -->
                    <div class="form-group">
                      ...
                      <label for="facebook_link" class="text-warning"><?=Arr::get($errors, 'facebook_link'); ?></label>
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'facebook_link'); ?>" id="facebook_link" placeholder="Team Member Facebook Link" name="facebook_link">
                      </div>
                    </div><!-- /.form-group -->
                    <div class="form-group">
                      ...
                      <label for="linkedIn_link" class="text-warning"><?=Arr::get($errors, 'linkedIn_link'); ?></label>
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'linkedIn_link'); ?>" id="linkedIn_link" placeholder="Team Member LinkedIn Link" name="linkedIn_link">
                      </div>
                    </div><!-- /.form-group -->
                  <div class="form-group">
