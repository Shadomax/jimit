<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Add FAQ
            <small>Use these section to add new <abbr title="Frequently Asked Question">FAQ</abbr>.</small>
          </h1>
          <ol class="breadcrumb">
			...
			<!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">FAQ Add Form</h3>
                </div><!-- /.box-header -->
                <?php if (!empty($errors)): ?>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <label for="question" class="text-warning"><?=Arr::get($errors, 'question'); ?></label>
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'question'); ?>" id="question" placeholder="FAQ Question" name="question">
                      </div>
                    </div><!-- /.form-group -->
                  <div class="form-group">
                    ...
                    <label for="answer" class="text-warning"><?=Arr::get($errors, 'answer'); ?></label>
                        ...
                        <!-- tools box -->
			                ...
			                <div class="box-body pad">
			                    <textarea class="wysiwygtextarea" name="answer" placeholder="Place your Answer here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=Arr::get($values, 'answer'); ?></textarea>
			                </div>
			              </div>
                  	</div>
                  </div><!-- /.form-group -->
