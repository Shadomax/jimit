<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Add Suites
            <small>Use these section to add new suite content.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?=url::site('admin/dashboard')?>"><i class="fa fa-dashboard"></i> Admin</a></li>
            <li><a href="<?=url::site('admin/gallery')?>">Suites</a></li>
            <li class="active">Add Suites</li>
          </ol>
        </section>
			...
			<!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Suites Add Form</h3>
                </div><!-- /.box-header -->
                <?php if (!empty($errors)): ?>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <label for="title" class="text-warning"><?=Arr::get($errors, 'title'); ?></label>
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'title'); ?>" id="title" placeholder="Suite Name" name="title">
                      </div>
                    </div><!-- /.form-group -->
                  <div class="form-group">
