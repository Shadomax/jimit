<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Admin Add Portfolio Category
            <small>Use these section to add new portfolio category.</small>
          </h1>
          <ol class="breadcrumb">
			...
			<!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Portfolio Category Add Form</h3>
                </div><!-- /.box-header -->
                <?php if (!empty($errors)): ?>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <label for="title" class="text-warning"><?=Arr::get($errors, 'title'); ?></label>
                        <input type="text" class="form-control" value="<?=Arr::get($values, 'title'); ?>" id="title" placeholder="Portfolio category Name" name="title">
                      </div>
                    </div><!-- /.form-group -->
                  <div class="form-group">
                    ...
                    <label for="content" class="text-warning"><?=Arr::get($errors, 'content'); ?></label>
                  		<div class="box">
			                ...
			                <div class="box-body pad">
			                    <textarea class="wysiwygtextarea" name="content" placeholder="Place your Portfolio category content here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=Arr::get($values, 'content'); ?></textarea>
			                </div>
			              </div>
                  	</div>
                  </div><!-- /.form-group -->
